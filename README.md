...
- [ ] Describe how web servers work.
        ...
        A web server can either be a computer is connected to the internet and stores the code for a website to be shared across the web. The server acts as a host to our website. The server needs its own code or instructions as well, this code is known as the software program that is also referred as a web server. 
...
- [ ] Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers.
  ...
  Read - axios.get (“url”)
  Update- axios.put (“url”)
  Delete- axis.delete (“url”) 
